! function(e) {
  ...
  function u(e, t) {
    var n = "";
    return l(e) ? (n = "Binary data of length " + e.byteLength, t && (n += ". Content: '" + function(e) {
      ...
      return a(this, function(a) {
        switch (a.label) {
          case 0:
            return s ? [4, s()] : [3, 2];
          case 1:
            (p = a.sent()) && ((i = {}).Authorization = "Bearer " + p, h = i), a.label = 2;
          case 2:
            return e.log(r.a.Trace, "(" + t + " transport) sending data. " + u(c, f) + "."), d = l(c) ? "arraybuffer" : "text", [4, n.post(o, {
              content: c,
              headers: h,
              responseType: d
            })];
          case 3:
            return g = a.sent(), e.log(r.a.Trace, "(" + t + " transport) request complete. Response status: " + g.statusCode + "."), [2]
        }
      })
    })
  }
  ...
  var r, o, i = n(3),
    ...
    l = function(e) {
      ...
      return u(t, e), t.prototype.send = function(e) {
        var t = this;
        return e.abortSignal && e.abortSignal.aborted ? Promise.reject(new i.a) : e.method ? e.url ? new Promise(function(n, r) {
          var o = new XMLHttpRequest;
          o.open(e.method, e.url, !0), o.withCredentials = !0, o.setRequestHeader("X-Requested-With", "XMLHttpRequest"), o.setRequestHeader("Content-Type", "text/plain;charset=UTF-8");
          var s = e.headers;
          s && Object.keys(s).forEach(function(e) {
            ...
            e.abortSignal && (e.abortSignal.onabort = null), o.status >= 200 && o.status < 300 ? n(new a.b(o.status, o.statusText, o.response || o.responseText)) : r(new i.b(o.statusText, o.status))
          }, o.onerror = function() {
            t.logger.log(c.a.Warning, "Error from HTTP request. " + o.status + ": " + o.statusText + "."), r(new i.b(o.statusText, o.status))
          }, o.ontimeout = function() {
            t.logger.log(c.a.Warning, "Timeout from HTTP request."), r(new i.c)
          }, o.send(e.content || "")
    ...
    h = function(e) {
      function t(t) {
        var n = e.call(this) || this;
        return "undefined" != typeof XMLHttpRequest ? n.httpClient = new l(t) : n.httpClient = new s.a(t), n
      }
      return f(t, e), t.prototype.send = function(e) {
        return e.abortSignal && e.abortSignal.aborted ? Promise.reject(new i.a) : e.method ? e.url ? this.httpClient.send(e) : Promise.reject(new Error("No url defined.")) : Promise.reject(new Error("No method defined."))
  ...
  var E, S, C = function() {
      function e(e, t, n, r) {
        var i = this;
        g.a.isRequired(e, "connection"), g.a.isRequired(t, "logger"), g.a.isRequired(n, "protocol"), this.serverTimeoutInMilliseconds = m, this.keepAliveIntervalInMilliseconds = w, this.logger = t, this.protocol = n, this.connection = e, this.reconnectPolicy = r, this.handshakeProtocol = new p.a, this.connection.onreceive = function(e) {
          return i.processIncomingData(e)
        }, this.connection.onclose = function(e) {
          return i.connectionClosed(e)
        }, this.callbacks = {}, this.methods = {}, this.closedCallbacks = [], this.reconnectingCallbacks = [], this.reconnectedCallbacks = [], this.invocationId = 0, this.receivedHandshakeResponse = !1, this.connectionState = d.Disconnected, this.connectionStarted = !1, this.cachedPingMessage = this.protocol.writeMessage({
          type: o.Ping
        })
      }
      return e.create = function(t, n, r, o) {
        ...
        set: function(e) {
          if (this.connectionState !== d.Disconnected && this.connectionState !== d.Reconnecting) throw new Error("The HubConnection must be in the Disconnected or Reconnecting state to change the url.");
        ...
        return v(this, void 0, void 0, function() {
          ...
          return b(this, function(t) {
            switch (t.label) {
              case 0:
                if (this.connectionState !== d.Disconnected) return [2, Promise.reject(new Error("Cannot start a HubConnection that is not in the 'Disconnected' state."))];
                this.connectionState = d.Connecting, this.logger.log(c.a.Debug, "Starting HubConnection."), t.label = 1;
              case 1:
                return t.trys.push([1, 3, , 4]), [4, this.startInternal()];
              case 2:
                return t.sent(), this.connectionState = d.Connected, this.connectionStarted = !0, this.logger.log(c.a.Debug, "HubConnection connected successfully."), [3, 4];
              case 3:
                return e = t.sent(), this.connectionState = d.Disconnected, this.logger.log(c.a.Debug, "HubConnection failed to start successfully because of error '" + e + "'."), [2, Promise.reject(e)];
              case 4:
                return [2]
            }
          })
          ...
          return b(this, function(o) {
            switch (o.label) {
              ...
              case 2:
                ...
                }, this.logger.log(c.a.Debug, "Sending handshake request."), [4, this.sendMessage(this.handshakeProtocol.writeHandshakeRequest(t))];
              case 3:
                return o.sent(), this.logger.log(c.a.Information, "Using HubProtocol '" + this.protocol.name + "'."), this.cleanupTimeout(), this.resetTimeoutPeriod(), this.resetKeepAliveInterval(), [4, e];
              case 4:
                if (o.sent(), this.stopDuringStartError) throw this.stopDuringStartError;
                return [3, 7];
              case 5:
                return n = o.sent(), this.logger.log(c.a.Debug, "Hub handshake failed with error '" + n + "' during start(). Stopping HubConnection."), this.cleanupTimeout(), this.cleanupPingTimer(), [4, this.connection.stop(n)];
              case 6:
                throw o.sent(), n;
              case 7:
                return [2]
        ...
        return l.cancelCallback = function() {
          ...
          return delete t.callbacks[u.invocationId], i.then(function() {
            return t.sendWithProtocol(e)
          })
        }, this.callbacks[u.invocationId] = function(e, t) {
          t ? l.error(t) : e && (e.type === o.Completion ? e.error ? l.error(new Error(e.error)) : l.complete() : l.next(e.item))
        }, i = this.sendWithProtocol(u).catch(function(e) {
          l.error(e), delete t.callbacks[u.invocationId]
        }), this.launchStreams(s, i), l
        ...
        return new Promise(function(e, n) {
          t.callbacks[c.invocationId] = function(t, r) {
            r ? n(r) : t && (t.type === o.Completion ? t.error ? n(new Error(t.error)) : e(t.result) : n(new Error("Unexpected message type: " + t.type)))
          };
          ...
          for (var t = 0, n = this.protocol.parseMessages(e, this.logger); t < n.length; t++) {
            ...
            switch (r.type) {
              ...
              case o.Completion:
                ...
                i && (r.type === o.Completion && delete this.callbacks[r.invocationId], i(r));
                break;
              case o.Ping:
                break;
              case o.Close:
                this.logger.log(c.a.Information, "Close message received from server.");
                var a = r.error ? new Error("Server returned an error on close: " + r.error) : void 0;
                !0 === r.allowReconnect ? this.connection.stop(a) : this.stopPromise = this.stopInternal(a);
                break;
              default:
                this.logger.log(c.a.Warning, "Invalid message type: " + r.type + ".")
            }
          }
        ...
        return this.logger.log(c.a.Debug, "Server handshake complete."), this.handshakeResolver(), r
        ...
        this.cleanupPingTimer(), this.pingServerHandle = setTimeout(function() {
          return v(e, void 0, void 0, function() {
            return b(this, function(e) {
              switch (e.label) {
                case 0:
                  if (this.connectionState !== d.Connected) return [3, 4];
                  e.label = 1;
                case 1:
        ...
        if (n) {
          try {
            ...
            this.logger.log(c.a.Error, "A callback for the method " + e.target.toLowerCase() + " threw error '" + t + "'.")
          }
          if (e.invocationId) {
            var r = "Server requested a response, which is not supported in this version of the client.";
            this.logger.log(c.a.Error, r), this.stopPromise = this.stopInternal(new Error(r))
          }
        } else this.logger.log(c.a.Warning, "No client method with the name '" + e.target + "' found.")
      }, e.prototype.connectionClosed = function(e) {
        this.logger.log(c.a.Debug, "HubConnection.connectionClosed(" + e + ") called while in state " + this.connectionState + "."), this.stopDuringStartError = this.stopDuringStartError || e || new Error("The underlying connection was closed before the hub handshake could complete."), this.handshakeResolver && this.handshakeResolver(), this.cancelCallbacksWithError(e || new Error("Invocation canceled due to the underlying connection being closed.")), this.cleanupTimeout(), this.cleanupPingTimer(), this.connectionState === d.Disconnecting ? this.completeClose(e) : this.connectionState === d.Connected && this.reconnectPolicy ? this.reconnect(e) : this.connectionState === d.Connected && this.completeClose(e)
      }, e.prototype.completeClose = function(e) {
        var t = this;
        if (this.connectionStarted) {
          this.connectionState = d.Disconnected, this.connectionStarted = !1;
          try {
            this.closedCallbacks.forEach(function(n) {
              return n.apply(t, [e])
            })
          } catch (t) {
            this.logger.log(c.a.Error, "An onclose callback called with error '" + e + "' threw error '" + t + "'.")
          }
        }
        ...
        return v(this, void 0, void 0, function() {
          ...
          return b(this, function(s) {
            switch (s.label) {
              case 0:
                if (t = Date.now(), n = 0, r = void 0 !== e ? e : new Error("Attempting to reconnect due to a unknown error."), null === (o = this.getNextRetryDelay(n++, 0, r))) return this.logger.log(c.a.Debug, "Connection not reconnecting because the IRetryPolicy returned null on the first reconnect attempt."), this.completeClose(e), [2];
                if (this.connectionState = d.Reconnecting, e ? this.logger.log(c.a.Information, "Connection reconnecting because of error '" + e + "'.") : this.logger.log(c.a.Information, "Connection reconnecting."), this.onreconnecting) {
                  try {
                    this.reconnectingCallbacks.forEach(function(t) {
                      return t.apply(a, [e])
                    })
                  } catch (t) {
                    this.logger.log(c.a.Error, "An onreconnecting callback called with error '" + e + "' threw error '" + t + "'.")
                  }
                  if (this.connectionState !== d.Reconnecting) return this.logger.log(c.a.Debug, "Connection left the reconnecting state in onreconnecting callback. Done reconnecting."), [2]
                }
                s.label = 1;
              case 1:
                return null === o ? [3, 7] : (this.logger.log(c.a.Information, "Reconnect attempt number " + n + " will start in " + o + " ms."), [4, new Promise(function(e) {
                  a.reconnectDelayHandle = setTimeout(e, o)
                })]);
              case 2:
                if (s.sent(), this.reconnectDelayHandle = void 0, this.connectionState !== d.Reconnecting) return this.logger.log(c.a.Debug, "Connection left the reconnecting state during reconnect delay. Done reconnecting."), [2];
                s.label = 3;
              case 3:
                return s.trys.push([3, 5, , 6]), [4, this.startInternal()];
              case 4:
                if (s.sent(), this.connectionState = d.Connected, this.logger.log(c.a.Information, "HubConnection reconnected successfully."), this.onreconnected) try {
                  this.reconnectedCallbacks.forEach(function(e) {
                    return e.apply(a, [a.connection.connectionId])
                  })
                } catch (e) {
                  this.logger.log(c.a.Error, "An onreconnected callback called with connectionId '" + this.connection.connectionId + "; threw error '" + e + "'.")
                }
                return [2];
              case 5:
                return i = s.sent(), this.logger.log(c.a.Information, "Reconnect attempt failed because of error '" + i + "'."), this.connectionState !== d.Reconnecting ? (this.logger.log(c.a.Debug, "Connection left the reconnecting state during reconnect attempt. Done reconnecting."), [2]) : (r = i instanceof Error ? i : new Error(i.toString()), o = this.getNextRetryDelay(n++, Date.now() - t, r), [3, 6]);
              case 6:
                return [3, 1];
              case 7:
                return this.logger.log(c.a.Information, "Reconnect retries have been exhausted after " + (Date.now() - t) + " ms and " + n + " failed attempts. Connection disconnecting."), this.completeClose(), [2]
            }
          })
        })
        ...
        try {
          ...
          return this.logger.log(c.a.Error, "IRetryPolicy.nextRetryDelayInMilliseconds(" + e + ", " + t + ") threw error '" + n + "'."), null
        }
    ...
    _ = [0, 2e3, 1e4, 3e4, null],
    I = function() {
      function e(e) {
        this.retryDelays = void 0 !== e ? e.concat([null]) : _
      }
  ...
  var T = function() {
    ...
    x = function() {
      function e(e, t, n, r) {
        this.httpClient = e, this.accessTokenFactory = t, this.logger = n, this.pollAbort = new T, this.logMessageContent = r, this.running = !1, this.onreceive = null, this.onclose = null
      }
      return Object.defineProperty(e.prototype, "pollAborted", {
        ...
        return k(this, void 0, void 0, function() {
          ...
          return P(this, function(s) {
            switch (s.label) {
              case 0:
                if (g.a.isRequired(e, "url"), g.a.isRequired(t, "transferFormat"), g.a.isIn(t, S, "transferFormat"), this.url = e, this.logger.log(c.a.Trace, "(LongPolling transport) Connecting."), t === S.Binary && "undefined" != typeof XMLHttpRequest && "string" != typeof(new XMLHttpRequest).responseType) throw new Error("Binary protocols over XmlHttpRequest not implementing advanced features are not supported.");
                return n = {
                  abortSignal: this.pollAbort.signal,
                  headers: {},
                  timeout: 1e5
                }, t === S.Binary && (n.responseType = "arraybuffer"), [4, this.getAccessToken()];
              case 1:
                return r = s.sent(), this.updateHeaderToken(n, r), o = e + "&_=" + Date.now(), this.logger.log(c.a.Trace, "(LongPolling transport) polling: " + o + "."), [4, this.httpClient.get(o, n)];
              case 2:
                return 200 !== (a = s.sent()).statusCode ? (this.logger.log(c.a.Error, "(LongPolling transport) Unexpected response code: " + a.statusCode + "."), this.closeError = new i.b(a.statusText || "", a.statusCode), this.running = !1) : this.running = !0, this.receiving = this.poll(this.url, n), [2]
            }
          })
        })
        ...
        return k(this, void 0, void 0, function() {
          ...
          return P(this, function(s) {
            switch (s.label) {
              ...
              case 3:
                return s.trys.push([3, 5, , 6]), r = e + "&_=" + Date.now(), this.logger.log(c.a.Trace, "(LongPolling transport) polling: " + r + "."), [4, this.httpClient.get(r, t)];
              case 4:
                return 204 === (o = s.sent()).statusCode ? (this.logger.log(c.a.Information, "(LongPolling transport) Poll terminated by server."), this.running = !1) : 200 !== o.statusCode ? (this.logger.log(c.a.Error, "(LongPolling transport) Unexpected response code: " + o.statusCode + "."), this.closeError = new i.b(o.statusText || "", o.statusCode), this.running = !1) : o.content ? (this.logger.log(c.a.Trace, "(LongPolling transport) data received. " + Object(g.f)(o.content, this.logMessageContent) + "."), this.onreceive && this.onreceive(o.content)) : this.logger.log(c.a.Trace, "(LongPolling transport) Poll timed out, reissuing."), [3, 6];
              case 5:
                return a = s.sent(), this.running ? a instanceof i.c ? this.logger.log(c.a.Trace, "(LongPolling transport) Poll timed out, reissuing.") : (this.closeError = a, this.running = !1) : this.logger.log(c.a.Trace, "(LongPolling transport) Poll errored after shutdown: " + a.message), [3, 6];
              case 6:
                return [3, 1];
              case 7:
                return [3, 9];
              case 8:
                return this.logger.log(c.a.Trace, "(LongPolling transport) Polling complete."), this.pollAborted || this.raiseOnClose(), [7];
              case 9:
                return [2]
            }
          })
        ...
        return k(this, void 0, void 0, function() {
          return P(this, function(t) {
            return this.running ? [2, Object(g.h)(this.logger, "LongPolling", this.httpClient, this.url, this.accessTokenFactory, e, this.logMessageContent)] : [2, Promise.reject(new Error("Cannot send until the transport is connected"))]
          })
        })
      }, e.prototype.stop = function() {
        return k(this, void 0, void 0, function() {
          ...
          return P(this, function(n) {
            switch (n.label) {
              case 0:
                this.logger.log(c.a.Trace, "(LongPolling transport) Stopping polling."), this.running = !1, this.pollAbort.abort(), n.label = 1;
              case 1:
                return n.trys.push([1, , 5, 6]), [4, this.receiving];
              case 2:
                return n.sent(), this.logger.log(c.a.Trace, "(LongPolling transport) sending DELETE request to " + this.url + "."), e = {
                  headers: {}
                }, [4, this.getAccessToken()];
              case 3:
                return t = n.sent(), this.updateHeaderToken(e, t), [4, this.httpClient.delete(this.url, e)];
              case 4:
                return n.sent(), this.logger.log(c.a.Trace, "(LongPolling transport) DELETE request sent."), [3, 6];
              case 5:
                return this.logger.log(c.a.Trace, "(LongPolling transport) Stop finished."), this.raiseOnClose(), [7];
              case 6:
                return [2]
            }
          })
        ...
        if (this.onclose) {
          ...
          this.closeError && (e += " Error: " + this.closeError), this.logger.log(c.a.Trace, e), this.onclose(this.closeError)
        }
      }, e
    }(),
    R = function(e, t, n, r) {
    ...
    O = function() {
      function e(e, t, n, r, o) {
        this.httpClient = e, this.accessTokenFactory = t, this.logger = n, this.logMessageContent = r, this.eventSourceConstructor = o, this.onreceive = null, this.onclose = null
      }
      return e.prototype.connect = function(e, t) {
        return R(this, void 0, void 0, function() {
          ...
          return D(this, function(o) {
            switch (o.label) {
              case 0:
                return g.a.isRequired(e, "url"), g.a.isRequired(t, "transferFormat"), g.a.isIn(t, S, "transferFormat"), this.logger.log(c.a.Trace, "(SSE transport) Connecting."), this.url = e, this.accessTokenFactory ? [4, this.accessTokenFactory()] : [3, 2];
              case 1:
              ...
              case 2:
                return [2, new Promise(function(n, o) {
                  ...
                  if (t === S.Text) {
                    var a;
                    if (g.c.isBrowser || g.c.isWebWorker) a = new r.eventSourceConstructor(e, {
                      withCredentials: !0
                    });
                    else {
                    ...
                    try {
                      a.onmessage = function(e) {
                        if (r.onreceive) try {
                          r.logger.log(c.a.Trace, "(SSE transport) data received. " + Object(g.f)(e.data, r.logMessageContent) + "."), r.onreceive(e.data)
                        } catch (e) {
                        ...
                        r.logger.log(c.a.Information, "SSE connected to " + r.url), r.eventSource = a, i = !0, n()
                      }
                    } catch (e) {
                      return void o(e)
                    }
        ...
        return R(this, void 0, void 0, function() {
          return D(this, function(t) {
            return this.eventSource ? [2, Object(g.h)(this.logger, "SSE", this.httpClient, this.url, this.accessTokenFactory, e, this.logMessageContent)] : [2, Promise.reject(new Error("Cannot send until the transport is connected"))]
          })
        })
      }, e.prototype.stop = function() {
    ...
    A = function() {
      function e(e, t, n, r, o) {
        this.logger = n, this.accessTokenFactory = t, this.logMessageContent = r, this.webSocketConstructor = o, this.httpClient = e, this.onreceive = null, this.onclose = null
      }
      return e.prototype.connect = function(e, t) {
        return L(this, void 0, void 0, function() {
          ...
          return M(this, function(o) {
            switch (o.label) {
              case 0:
                return g.a.isRequired(e, "url"), g.a.isRequired(t, "transferFormat"), g.a.isIn(t, S, "transferFormat"), this.logger.log(c.a.Trace, "(WebSockets transport) Connecting."), this.accessTokenFactory ? [4, this.accessTokenFactory()] : [3, 2];
              case 1:
                (n = o.sent()) && (e += (e.indexOf("?") < 0 ? "?" : "&") + "access_token=" + encodeURIComponent(n)), o.label = 2;
              case 2:
                return [2, new Promise(function(n, o) {
                  ...
                  var a = r.httpClient.getCookieString(e),
                    s = !1;
                  g.c.isNode && a && (i = new r.webSocketConstructor(e, void 0, {
                    headers: {
                      Cookie: "" + a
                    }
                  })), i || (i = new r.webSocketConstructor(e)), t === S.Binary && (i.binaryType = "arraybuffer"), i.onopen = function(t) {
                    r.logger.log(c.a.Information, "WebSocket connected to " + e + "."), r.webSocket = i, s = !0, n()
                    ...
                    r.logger.log(c.a.Trace, "(WebSockets transport) data received. " + Object(g.f)(e.data, r.logMessageContent) + "."), r.onreceive && r.onreceive(e.data)
        ...
        return this.webSocket && this.webSocket.readyState === this.webSocketConstructor.OPEN ? (this.logger.log(c.a.Trace, "(WebSockets transport) sending data. " + Object(g.f)(e, this.logMessageContent) + "."), this.webSocket.send(e), Promise.resolve()) : Promise.reject("WebSocket is not in the OPEN state")
      }, e.prototype.stop = function() {
        return this.webSocket && (this.webSocket.onclose = function() {}, this.webSocket.onmessage = function() {}, this.webSocket.onerror = function() {}, this.webSocket.close(), this.webSocket = void 0, this.close(void 0)), Promise.resolve()
      }, e.prototype.close = function(e) {
        this.logger.log(c.a.Trace, "(WebSockets transport) socket closed."), this.onclose && (!e || !1 !== e.wasClean && 1e3 === e.code ? this.onclose() : this.onclose(new Error("WebSocket closed with status code: " + e.code + " (" + e.reason + ").")))
      }, e
    }(),
    B = function(e, t, n, r) {
      return new(n || (n = Promise))(function(o, i) {
  ...
  if (g.c.isNode) {
    var F = require;
    U = F("ws"), N = F("eventsource")
  }
  var H = function() {
    function e(e, t) {
      void 0 === t && (t = {}), this.features = {}, this.negotiateVersion = 1, g.a.isRequired(e, "url"), this.logger = Object(g.e)(t.logger), this.baseUrl = this.resolveUrl(e), (t = t || {}).logMessageContent = t.logMessageContent || !1, g.c.isNode || "undefined" == typeof WebSocket || t.WebSocket ? g.c.isNode && !t.WebSocket && U && (t.WebSocket = U) : t.WebSocket = WebSocket, g.c.isNode || "undefined" == typeof EventSource || t.EventSource ? g.c.isNode && !t.EventSource && void 0 !== N && (t.EventSource = N) : t.EventSource = EventSource, this.httpClient = t.httpClient || new h(this.logger), this.connectionState = "Disconnected", this.connectionStarted = !1, this.options = t, this.onreceive = null, this.onclose = null
    }
    return e.prototype.start = function(e) {
      return B(this, void 0, void 0, function() {
        ...
        return j(this, function(n) {
          switch (n.label) {
            case 0:
              return e = e || S.Binary, g.a.isIn(e, S, "transferFormat"), this.logger.log(c.a.Debug, "Starting connection with transfer format '" + S[e] + "'."), "Disconnected" !== this.connectionState ? [2, Promise.reject(new Error("Cannot start an HttpConnection that is not in the 'Disconnected' state."))] : (this.connectionState = "Connecting ", this.startInternalPromise = this.startInternal(e), [4, this.startInternalPromise]);
            case 1:
              return n.sent(), "Disconnecting" !== this.connectionState ? [3, 3] : (t = "Failed to start the HttpConnection before stop() was called.", this.logger.log(c.a.Error, t), [4, this.stopPromise]);
            case 2:
              return n.sent(), [2, Promise.reject(new Error(t))];
            case 3:
              if ("Connected" !== this.connectionState) return t = "HttpConnection.startInternal completed gracefully but didn't enter the connection into the connected state!", this.logger.log(c.a.Error, t), [2, Promise.reject(new Error(t))];
              n.label = 4;
            case 4:
      ...
      return "Connected" !== this.connectionState ? Promise.reject(new Error("Cannot send data if the connection is not in the 'Connected' State.")) : (this.sendQueue || (this.sendQueue = new q(this.transport)), this.sendQueue.send(e))
      ...
      return B(this, void 0, void 0, function() {
        ...
        return j(this, function(n) {
          switch (n.label) {
            case 0:
              return "Disconnected" === this.connectionState ? (this.logger.log(c.a.Debug, "Call to HttpConnection.stop(" + e + ") ignored because the connection is already in the disconnected state."), [2, Promise.resolve()]) : "Disconnecting" === this.connectionState ? (this.logger.log(c.a.Debug, "Call to HttpConnection.stop(" + e + ") ignored because the connection is already in the disconnecting state."), [2, this.stopPromise]) : (this.connectionState = "Disconnecting", this.stopPromise = new Promise(function(e) {
      ...
      return B(this, void 0, void 0, function() {
        ...
        return j(this, function(r) {
          switch (r.label) {
            case 0:
              this.stopError = e, r.label = 1;
            case 1:
              return r.trys.push([1, 3, , 4]), [4, this.startInternalPromise];
            case 2:
              return r.sent(), [3, 4];
            case 3:
              return r.sent(), [3, 4];
            case 4:
              ...
              r.label = 5;
            case 5:
              return r.trys.push([5, 7, , 8]), [4, this.sendQueue.stop()];
            case 6:
              return r.sent(), [3, 8];
            case 7:
              return t = r.sent(), this.logger.log(c.a.Error, "TransportSendQueue.stop() threw error '" + t + "'."), [3, 8];
            case 8:
              this.sendQueue = void 0, r.label = 9;
            case 9:
              if (!this.transport) return [3, 14];
              r.label = 10;
            case 10:
              return r.trys.push([10, 12, , 13]), [4, this.transport.stop()];
            case 11:
              return r.sent(), [3, 13];
            case 12:
              return n = r.sent(), this.logger.log(c.a.Error, "HttpConnection.transport.stop() threw error '" + n + "'."), this.stopConnection(), [3, 13];
            case 13:
              return this.transport = void 0, [3, 15];
            case 14:
              this.logger.log(c.a.Debug, "HttpConnection.transport is undefined in HttpConnection.stop() because start() failed."), this.stopConnection(), r.label = 15;
            case 15:
              return [2]
          }
        })
      ...
      return B(this, void 0, void 0, function() {
        ...
        return j(this, function(s) {
          switch (s.label) {
            ...
            case 1:
              return s.trys.push([1, 12, , 13]), this.options.skipNegotiation ? this.options.transport !== E.WebSockets ? [3, 3] : (this.transport = this.constructTransport(E.WebSockets), [4, this.startTransport(t, e)]) : [3, 5];
            case 2:
              return s.sent(), [3, 4];
            case 3:
            ...
            case 10:
              s.sent(), s.label = 11;
            case 11:
              return this.transport instanceof x && (this.features.inherentKeepAlive = !0), "Connecting " === this.connectionState && (this.logger.log(c.a.Debug, "The HttpConnection connected successfully."), this.connectionState = "Connected"), [3, 13];
            case 12:
              return a = s.sent(), this.logger.log(c.a.Error, "Failed to start the connection: " + a), this.connectionState = "Disconnected", this.transport = void 0, [2, Promise.reject(a)];
            case 13:
              return [2]
          }
        })
        ...
        return j(this, function(u) {
          switch (u.label) {
            case 0:
              return this.accessTokenFactory ? [4, this.accessTokenFactory()] : [3, 2];
            case 1:
              (r = u.sent()) && ((t = {}).Authorization = "Bearer " + r, n = t), u.label = 2;
            case 2:
              o = this.resolveNegotiateUrl(e), this.logger.log(c.a.Debug, "Sending negotiation request: " + o + "."), u.label = 3;
            case 3:
              return u.trys.push([3, 5, , 6]), [4, this.httpClient.post(o, {
                content: "",
                headers: n
              })];
            case 4:
              return 200 !== (i = u.sent()).statusCode ? [2, Promise.reject(new Error("Unexpected status code returned from negotiate " + i.statusCode))] : ((!(a = JSON.parse(i.content)).negotiateVersion || a.negotiateVersion < 1) && (a.connectionToken = a.connectionId), [2, a]);
            case 5:
              return s = u.sent(), this.logger.log(c.a.Error, "Failed to complete negotiation with the server: " + s), [2, Promise.reject(s)];
            case 6:
              return [2]
          }
        })
      ...
      return B(this, void 0, void 0, function() {
        ...
        return j(this, function(y) {
          switch (y.label) {
            case 0:
              return o = this.createConnectUrl(e, n.connectionToken), this.isITransport(t) ? (this.logger.log(c.a.Debug, "Connection was provided an instance of ITransport, using that directly."), this.transport = t, [4, this.startTransport(o, r)]) : [3, 2];
            case 1:
              return y.sent(), this.connectionId = n.connectionId, [2];
            case 2:
              i = [], a = n.availableTransports || [], s = n, u = 0, l = a, y.label = 3;
            case 3:
              return u < l.length ? (f = l[u], (h = this.resolveTransportOrError(f, t, r)) instanceof Error ? (i.push(f.transport + " failed: " + h), [3, 12]) : [3, 4]) : [3, 13];
            case 4:
            ...
            case 11:
              return d = y.sent(), this.logger.log(c.a.Error, "Failed to start the transport '" + f.transport + "': " + d), s = void 0, i.push(f.transport + " failed: " + d), "Connecting " !== this.connectionState ? (g = "Failed to select transport before stop() was called.", this.logger.log(c.a.Debug, g), [2, Promise.reject(new Error(g))]) : [3, 12];
            case 12:
              return u++, [3, 3];
            case 13:
      ...
      switch (e) {
        case E.WebSockets:
          ...
          return new A(this.httpClient, this.accessTokenFactory, this.logger, this.options.logMessageContent || !1, this.options.WebSocket);
        case E.ServerSentEvents:
          if (!this.options.EventSource) throw new Error("'EventSource' is not supported in your environment.");
          return new O(this.httpClient, this.accessTokenFactory, this.logger, this.options.logMessageContent || !1, this.options.EventSource);
        case E.LongPolling:
          return new x(this.httpClient, this.accessTokenFactory, this.logger, this.options.logMessageContent || !1);
        default:
      ...
      var r = E[e.transport];
      if (null == r) return this.logger.log(c.a.Debug, "Skipping transport '" + e.transport + "' because it is not supported by this client."), new Error("Skipping transport '" + e.transport + "' because it is not supported by this client.");
      if (! function(e, t) {
          return !e || 0 != (t & e)
        }(t, r)) return this.logger.log(c.a.Debug, "Skipping transport '" + E[r] + "' because it was disabled by the client."), new Error("'" + E[r] + "' is disabled by the client.");
      if (!(e.transferFormats.map(function(e) {
          return S[e]
        }).indexOf(n) >= 0)) return this.logger.log(c.a.Debug, "Skipping transport '" + E[r] + "' because it does not support the requested transfer format '" + S[n] + "'."), new Error("'" + E[r] + "' does not support " + S[n] + ".");
      if (r === E.WebSockets && !this.options.WebSocket || r === E.ServerSentEvents && !this.options.EventSource) return this.logger.log(c.a.Debug, "Skipping transport '" + E[r] + "' because it is not supported in your environment.'"), new Error("'" + E[r] + "' is not supported in your environment.");
      this.logger.log(c.a.Debug, "Selecting transport '" + E[r] + "'.");
      try {
      ...
      if (this.logger.log(c.a.Debug, "HttpConnection.stopConnection(" + e + ") called while in state " + this.connectionState + "."), this.transport = void 0, e = this.stopError || e, this.stopError = void 0, "Disconnected" !== this.connectionState)
        if ("Connecting " !== this.connectionState) {
          if ("Disconnecting" === this.connectionState && this.stopPromiseResolver(), e ? this.logger.log(c.a.Error, "Connection disconnected with error '" + e + "'.") : this.logger.log(c.a.Information, "Connection disconnected."), this.connectionId = void 0, this.connectionState = "Disconnected", this.onclose && this.connectionStarted) {
            this.connectionStarted = !1;
            try {
              this.onclose(e)
            } catch (t) {
              this.logger.log(c.a.Error, "HttpConnection.onclose(" + e + ") threw error '" + t + "'.")
            }
          }
        } else this.logger.log(c.a.Warning, "Call to HttpConnection.stopConnection(" + e + ") was ignored because the connection hasn't yet left the in the connecting state.");
      else this.logger.log(c.a.Debug, "Call to HttpConnection.stopConnection(" + e + ") was ignored because the connection is already in the disconnected state.")
    }, e.prototype.resolveUrl = function(e) {
      if (0 === e.lastIndexOf("https://", 0) || 0 === e.lastIndexOf("http://", 0)) return e;
      if (!g.c.isBrowser || !window.document) throw new Error("Cannot resolve '" + e + "'.");
      var t = window.document.createElement("a");
      return t.href = e, this.logger.log(c.a.Information, "Normalizing '" + e + "' to '" + t.href + "'."), t.href
  ...
  var q = function() {
      function e(e) {
        this.transport = e, this.buffer = [], this.executing = !0, this.sendBufferedData = new W, this.transportResult = new W, this.sendLoopPromise = this.sendLoop()
      }
      return e.prototype.send = function(e) {
        return this.bufferData(e), this.transportResult || (this.transportResult = new W), this.transportResult.promise
      }, e.prototype.stop = function() {
          ...
          return j(this, function(o) {
            switch (o.label) {
              ...
              case 1:
                ...
                this.sendBufferedData = new W, t = this.transportResult, this.transportResult = void 0, n = "string" == typeof this.buffer[0] ? this.buffer.join("") : e.concatBuffers(this.buffer), this.buffer.length = 0, o.label = 2;
              case 2:
    ...
    K = function() {
      function e() {
        this.name = J, this.version = 1, this.transferFormat = S.Text
      }
      return e.prototype.parseMessages = function(e, t) {
        ...
        for (var n = [], r = 0, i = Y.a.parse(e); r < i.length; r++) {
          var a = i[r],
            s = JSON.parse(a);
          ...
          switch (s.type) {
            ...
            case o.Close:
              break;
            default:
              t.log(c.a.Information, "Unknown message type '" + s.type + "' ignored.");
              continue
          }
          n.push(s)
        }
        ...
        return Y.a.write(JSON.stringify(e))
  ...
  var G = function() {
    ...
    return e.prototype.configureLogging = function(e) {
      ...
      return g.a.isRequired(e, "url"), this.url = e, this.httpConnectionOptions = V({}, this.httpConnectionOptions, "object" == typeof t ? t : {
        transport: t
      }), this
      ...
      return e ? Array.isArray(e) ? this.reconnectPolicy = new I(e) : this.reconnectPolicy = e : this.reconnectPolicy = new I, this
      ...
      var t = new H(this.url, e);
      return C.create(t, this.logger || z.a.instance, this.protocol || new K, this.reconnectPolicy)
    }, e
  }();
  ...
  t.attachRootComponentToLogicalElement = s, t.attachRootComponentToElement = function(e, t, n) {
    ...
    var y = t.disposedComponentIds(),
      v = r.values(y),
      b = r.count(y);
    for (h = 0; h < b; h++) d = t.disposedComponentIdsEntry(v, h), n.disposeComponent(d);
  ...
  (function(e) {
    ...
    c.prototype.slice = function(e, t) {
      ...
      return e = +e, t |= 0, n || O(this, e, t, 2, 65535, 0), c.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : L(this, e, t, !0), t + 2
    }, c.prototype.writeUInt16BE = function(e, t, n) {
      return e = +e, t |= 0, n || O(this, e, t, 2, 65535, 0), c.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : L(this, e, t, !1), t + 2
    }, c.prototype.writeUInt32LE = function(e, t, n) {
      return e = +e, t |= 0, n || O(this, e, t, 4, 4294967295, 0), c.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = 255 & e) : M(this, e, t, !0), t + 4
    }, c.prototype.writeUInt32BE = function(e, t, n) {
      return e = +e, t |= 0, n || O(this, e, t, 4, 4294967295, 0), c.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : M(this, e, t, !1), t + 4
      ...
      return e = +e, t |= 0, n || O(this, e, t, 2, 32767, -32768), c.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : L(this, e, t, !0), t + 2
    }, c.prototype.writeInt16BE = function(e, t, n) {
      return e = +e, t |= 0, n || O(this, e, t, 2, 32767, -32768), c.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : L(this, e, t, !1), t + 2
    }, c.prototype.writeInt32LE = function(e, t, n) {
      return e = +e, t |= 0, n || O(this, e, t, 4, 2147483647, -2147483648), c.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : M(this, e, t, !0), t + 4
    }, c.prototype.writeInt32BE = function(e, t, n) {
      return e = +e, t |= 0, n || O(this, e, t, 4, 2147483647, -2147483648), e < 0 && (e = 4294967295 + e + 1), c.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : M(this, e, t, !1), t + 4
  ...
  function l(e, t) {
    ...
    if (!t && d(n)) f(n, !1);
      ...
      var r = e + "?";
      history.replaceState(null, "", r), location.replace(e)
    } else location.href = e
  }

  function f(e, t) {
    a.resetScrollAfterNextBatch(), history.pushState(null, "", e), h(t)
  }
  ...
  t.toLogicalRootCommentElement = function(e, t) {
    ...
    if (r instanceof Comment)
      for (var o = u(r); o.length > 0;) e(r, 0);
    var i = r;
  ...
  ! function(e) {
    ...
    e.attachDispatcher = function(e) {
      i = e
    }, e.attachReviver = a, e.invokeMethod = function(e, t) {
      ...
      beginInvokeJSFromDotNet: function(e, t, n) {
        ...
        e && r.then(function(t) {
          return u().endInvokeJSFromDotNet(e, !0, JSON.stringify([e, !0, t], g))
        }, function(t) {
          return u().endInvokeJSFromDotNet(e, !1, JSON.stringify([e, !1, h(t)]))
        })
      },
    ...
    a(function(e, t) {
      return t && "object" == typeof t && t.hasOwnProperty("__dotNetObject") ? new d(t.__dotNetObject) : t
    })
  }(r || (r = {}))
}, function(e, t, n) {
  "use strict";
    ...
    p = function() {
      ...
      return e.prototype.attachRootComponentToLogicalElement = function(e, t) {
        ...
        var c = i.getClosestDomElement(o).ownerDocument,
          u = c && c.activeElement;
        this.applyEdits(e, t, o, 0, n, r), u instanceof HTMLElement && c && c.activeElement !== u && u.focus()
        ...
        for (var c, u = 0, l = o, f = e.arrayBuilderSegmentReader, h = e.editReader, p = e.frameReader, d = f.values(a), g = f.offset(a), y = g + f.count(a), v = g; v < y; v++) {
          ...
          switch (m) {
            ...
            case r.EditType.setAttribute:
              ...
              if (!((C = i.getLogicalChild(n, l + S)) instanceof Element)) throw new Error("Cannot set attribute on non-element child");
              this.applyAttribute(e, t, C, E);
              break;
            case r.EditType.removeAttribute:
              var C;
              S = h.siblingIndex(b);
              if (!((C = i.getLogicalChild(n, l + S)) instanceof HTMLElement)) throw new Error("Cannot remove attribute from non-element child");
              var _ = h.removedAttributeName(b);
              this.tryApplySpecialProperty(e, C, _, null) || C.removeAttribute(_);
              break;
            case r.EditType.updateText:
              w = h.newTreeIndex(b), E = e.referenceFramesEntry(s, w), S = h.siblingIndex(b);
              var I = i.getLogicalChild(n, l + S);
              if (!(I instanceof Text)) throw new Error("Cannot set text content on non-text child");
              I.textContent = p.textContent(E);
              break;
        ...
        var u = e.frameReader,
          l = u.elementName(s),
          f = "svg" === l || i.isSvgElement(n) ? document.createElementNS("http://www.w3.org/2000/svg", l) : document.createElement(l),
        ...
        switch (t.tagName) {
          ...
          case "TEXTAREA":
            ...
            return t.value = i, "SELECT" === t.tagName && (t._blazorSelectValue = i), !0;
          case "OPTION":
            (i = n ? r.attributeValue(n) : null) ? t.setAttribute("value", i): t.removeAttribute("value");
            var a = this.findClosestAncestorSelectElement(t);
            return a && "_blazorSelectValue" in a && a._blazorSelectValue === i && (this.tryApplyValueProperty(e, a, n), delete a._blazorSelectValue), !0;
          default:
            return !1
        }
  ...
  var r = n(29),
    o = n(30),
    i = l(["abort", "blur", "change", "error", "focus", "load", "loadend", "loadstart", "mouseenter", "mouseleave", "progress", "reset", "scroll", "submit", "unload", "DOMNodeInsertedIntoDocument", "DOMNodeRemovedFromDocument"]),
  ...
  (function(e) {
    ...
    function l(e, n, r) {
      ...
      var u, w = "",
        _ = !1,
        I = ["{", "}"];
      (p(n) && (_ = !0, I = ["[", "]"]), C(n)) && (w = " [Function" + (n.name ? ": " + n.name : "") + "]");
      return m(n) && (w = " " + RegExp.prototype.toString.call(n)), E(n) && (w = " " + Date.prototype.toUTCString.call(n)), S(n) && (w = " " + f(n)), 0 !== a.length || _ && 0 != n.length ? r < 0 ? m(n) ? e.stylize(RegExp.prototype.toString.call(n), "regexp") : e.stylize("[Object]", "special") : (e.seen.push(n), u = _ ? function(e, t, n, r, o) {
        for (var i = [], a = 0, s = t.length; a < s; ++a) k(t, String(a)) ? i.push(h(e, t, n, r, String(a), !0)) : i.push("");
        return o.forEach(function(o) {
          o.match(/^\d+$/) || i.push(h(e, t, n, r, o, !0))
        }), i
      }(e, n, r, s, a) : a.map(function(t) {
        return h(e, n, r, s, t, _)
    ...
    function h(e, t, n, r, o, i) {
      ...
      if ((c = Object.getOwnPropertyDescriptor(t, o) || {
          value: t[o]
        }).get ? s = c.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : c.set && (s = e.stylize("[Setter]", "special")), k(r, o) || (a = "[" + o + "]"), s || (e.seen.indexOf(c.value) < 0 ? (s = g(n) ? l(e, c.value, null) : l(e, c.value, n - 1)).indexOf("\n") > -1 && (s = i ? s.split("\n").map(function(e) {
          return "  " + e
        }).join("\n").substr(2) : "\n" + s.split("\n").map(function(e) {
          return "   " + e
    ...
    t.debuglog = function(n) {
      ...
      return "symbol" == typeof e
    }, t.isUndefined = b, t.isRegExp = m, t.isObject = w, t.isDate = E, t.isError = S, t.isFunction = C, t.isPrimitive = function(e) {
      return null === e || "boolean" == typeof e || "number" == typeof e || "string" == typeof e || "symbol" == typeof e || void 0 === e
    }, t.isBuffer = n(54);
    ...
    t.log = function() {
      var e, n;
      console.log("%s - %s", (e = new Date, n = [I(e.getHours()), I(e.getMinutes()), I(e.getSeconds())].join(":"), [e.getDate(), T[e.getMonth()], n].join(" ")), t.format.apply(t, arguments))
    }, t.inherits = n(55), t._extend = function(e, t) {
      if (!t || !w(t)) return e;
  ...
  (function(t, r) {
    ...
    function w(e, t, n, r, o) {
      ...
      null === t ? (a.reading = !1, function(e, t) {
        ...
        return u.from(e)
      }(t)), r ? a.endEmitted ? e.emit("error", new Error("stream.unshift() after end event")) : E(e, a, t, !0) : a.ended ? e.emit("error", new Error("stream.push() after EOF")) : (a.reading = !1, a.decoder && !n ? (t = a.decoder.write(t), a.objectMode || 0 !== t.length ? E(e, a, t, !1) : T(e, a)) : E(e, a, t, !1))) : r || (a.reading = !1));
      return function(e) {
    ...
    function E(e, t, n, r) {
      t.flowing && 0 === t.length && !t.sync ? (e.emit("data", n), e.read(0)) : (t.length += t.objectMode ? 1 : n.length, r ? t.buffer.unshift(n) : t.buffer.push(n), t.needReadable && _(e)), T(e, t)
    }
    Object.defineProperty(m.prototype, "destroyed", {
      ...
      return d || (d = n(40).StringDecoder), this._readableState.decoder = new d(e), this._readableState.encoding = e, this
    };
    var S = 8388608;
    ...
    m.prototype.read = function(e) {
      ...
      if (0 === (e = C(e, t)) && t.ended) return 0 === t.length && O(this), null;
      ...
      var f = function(e) {
        return function() {
          var t = e._readableState;
          p("pipeOnDrain", t.awaitDrain), t.awaitDrain && t.awaitDrain--, 0 === t.awaitDrain && s(e, "data") && (t.flowing = !0, R(e))
        }
      }(n);
      e.on("drain", f);
      var h = !1;
      ...
      function g(t) {
        p("ondata"), d = !1, !1 !== e.write(t) || d || ((1 === i.pipesCount && i.pipes === e || i.pipesCount > 1 && -1 !== M(i.pipes, e)) && !h && (p("false write response, pause", n._readableState.awaitDrain), n._readableState.awaitDrain++, d = !0), n.pause())
      }
      ...
      if ("data" === e) !1 !== this._readableState.flowing && this.resume();
        ...
        r.endEmitted || r.readableListening || (r.readableListening = r.needReadable = !0, r.emittedReadable = !1, r.reading ? r.length && _(this) : o.nextTick(P, this))
      }
      return n
  ...
  function l(e, t, n, r) {
    ...
    else if ("function" == typeof a ? a = i[t] = r ? [n, a] : [a, n] : r ? a.unshift(n) : a.push(n), (o = u(e)) > 0 && a.length > o && !a.warned) {
      a.warned = !0;
  ...
  (function(t, r, o) {
      ...
      this.decodeStrings = !f, this.defaultEncoding = e.defaultEncoding || "utf8", this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function(e) {
        ! function(e, t) {
          ...
          if (function(e) {
            ...
            --t.pendingcb, n ? (i.nextTick(o, r), i.nextTick(_, e, t), e._writableState.errorEmitted = !0, e.emit("error", r)) : (o(r), e._writableState.errorEmitted = !0, e.emit("error", r), _(e, t))
          }(e, n, r, t, o);
          else {
            var a = S(n);
    ...
    function b(e) {
      if (s = s || n(10), !(d.call(b, this) || this instanceof s)) return new b(e);
    ...
    function C(e, t) {
      e._final(function(n) {
        t.pendingcb--, n && e.emit("error", n), t.prefinished = !0, e.emit("prefinish"), _(e, t)
      })
    }
    ...
    function _(e, t) {
      ...
      return n && (! function(e, t) {
        t.prefinished || t.finalCalled || ("function" == typeof e._final ? (t.pendingcb++, t.finalCalled = !0, i.nextTick(C, e, t)) : (t.prefinished = !0, e.emit("prefinish")))
    ...
    u.inherits(b, f), v.prototype.getBuffer = function() {
      ...
      function() {
        ...
        "function" == typeof e ? (n = e, e = null, t = null) : "function" == typeof t && (n = t, t = null), null != e && this.write(e, t), r.corked && (r.corked = 1, this.uncork()), r.ending || r.finished || function(e, t, n) {
          t.ending = !0, _(e, t), n && (t.finished ? i.nextTick(n) : e.once("finish", n));
  ...
  }).call(this, n(20), n(62).setImmediate, n(9))
}, function(e, t, n) {
  "use strict";
  e.exports = a;
  var r = n(10),
  ...
  (function(e) {
    ...
    var h = function(t) {
      function n(e) {
        ...
        if (void 0 === o) throw new Error("The 'request' module could not be loaded.");
        return n.logger = e, n.cookieJar = o.jar(), n.request = o.defaults({
          jar: n.cookieJar
        }), n
      }
      return u(n, t), n.prototype.send = function(t) {
        var n = this;
        return new Promise(function(r, o) {
          var u;
          u = Object(c.g)(t.content) ? e.from(t.content) : t.content || "";
          var f = n.request(t.url, {
            body: u,
            encoding: "arraybuffer" === t.responseType ? null : "utf8",
            headers: l({
            ...
            if (t.abortSignal && (t.abortSignal.onabort = null), e) return "ETIMEDOUT" === e.code && (n.logger.log(s.a.Warning, "Timeout from HTTP request."), o(new i.c)), n.logger.log(s.a.Warning, "Error from HTTP request. " + e), void o(e);
            c.statusCode >= 200 && c.statusCode < 300 ? r(new a.b(c.statusCode, c.statusMessage || "", u)) : o(new i.b(c.statusMessage || "", c.statusCode || 0))
          });
      ...
      return o(this, function(l) {
        switch (l.label) {
          case 0:
            ...
            return w = !0, t = y.resolveOptions(e), n = new h.ConsoleLogger(t.logLevel), window.Blazor.defaultReconnectionHandler = new v.DefaultReconnectionHandler(n), t.reconnectionHandler = t.reconnectionHandler || window.Blazor.defaultReconnectionHandler, n.log(p.LogLevel.Information, "Starting up blazor server-side application."), i = d.discoverComponents(document), a = new d.CircuitDescriptor(i), [4, S(t, n, a)];
          case 1:
            return s = l.sent(), [4, a.startCircuit(s)];
          case 2:
            return l.sent() ? (c = function(e) {
              return r(u, void 0, void 0, function() {
                var r, i;
                return o(this, function(o) {
                  switch (o.label) {
                    case 0:
                      return m ? [2, !1] : (i = e) ? [3, 2] : [4, S(t, n, a)];
                    case 1:
                      i = o.sent(), o.label = 2;
                    case 2:
              ...
              var e = new FormData,
                t = a.circuitId;
              e.append("circuitId", t), navigator.sendBeacon("_blazor/disconnect", e)
            }, !1), window.Blazor.reconnect = c, n.log(p.LogLevel.Information, "Blazor server-side application started."), [2]) : (n.log(p.LogLevel.Error, "Failed to start the circuit."), [2])
        }
      })
    })
  }
  ...
  function S(e, t, n) {
    return r(this, void 0, void 0, function() {
      ...
      return o(this, function(o) {
        switch (o.label) {
          case 0:
            (r = new c.MessagePackHubProtocol).name = "blazorpack", i = (new s.HubConnectionBuilder).withUrl("_blazor").withHubProtocol(r), e.configureSignalR(i), l = i.build(), g.setEventDispatcher(function(e, t) {
              return l.send("DispatchBrowserEvent", JSON.stringify(e), JSON.stringify(t))
              ...
              return b.attachRootComponentToLogicalElement(0, n.resolveElement(t), e)
            }), l.on("JS.BeginInvokeJS", DotNet.jsCallDispatcher.beginInvokeJSFromDotNet), l.on("JS.EndInvokeDotNet", function(e) {
              var t;
              return (t = DotNet.jsCallDispatcher).endInvokeDotNetFromJS.apply(t, a(JSON.parse(e)))
            }), h = f.RenderQueue.getOrCreate(t), l.on("JS.RenderBatch", function(e, n) {
              t.log(p.LogLevel.Debug, "Received render batch with id " + e + " and " + n.byteLength + " bytes."), h.processBatch(e, n, l)
            }), l.onclose(function(t) {
              return !m && e.reconnectionHandler.onConnectionDown(e.reconnectionOptions, t)
            }), l.on("JS.Error", function(e) {
              m = !0, C(l, e, t), u.showErrorNotification()
          ...
          case 2:
            return o.sent(), [3, 4];
          case 3:
            return d = o.sent(), C(l, d, t), [3, 4];
          case 4:
            return DotNet.attachDispatcher({
              beginInvokeDotNetFromJS: function(e, t, n, r, o) {
                l.send("BeginInvokeDotNetFromJS", e ? e.toString() : null, t, n, r || 0, o)
              },
  ...
  t.byteLength = function(e) {
    ...
    for (var t, n = u(e), r = n[0], a = n[1], s = new i(function(e, t, n) {
        return 3 * (t + n) / 4 - n
      }(0, r, a)), c = 0, l = a > 0 ? r - 4 : r, f = 0; f < l; f += 4) t = o[e.charCodeAt(f)] << 18 | o[e.charCodeAt(f + 1)] << 12 | o[e.charCodeAt(f + 2)] << 6 | o[e.charCodeAt(f + 3)], s[c++] = t >> 16 & 255, s[c++] = t >> 8 & 255, s[c++] = 255 & t;
  ...
  (function(t) {
    ...
    function b(e, t, n, a) {
      ...
      if (null !== e && "object" == typeof e || null !== t && "object" == typeof t) {
        ...
        return -1 !== c && c === a.expected.indexOf(t) || (a.actual.push(e), a.expected.push(t), function(e, t, n, r) {
          ...
          for (u = l.length - 1; u >= 0; u--)
            if (c = l[u], !b(e[c], t[c], n, r)) return !1;
          return !0
        }(e, t, n, a))
      }
      return n ? e === t : e == t
    ...
    function E(e, t, n, r) {
      ...
      "string" == typeof n && (r = n, n = null), o = function(e) {
        ...
        return t
      }(t), r = (n && n.name ? " (" + n.name + ")." : ".") + (r ? " " + r : "."), e && !o && y(o, n, "Missing expected exception" + r);
      var a = "string" == typeof r,
        s = !e && o && !n;
      if ((!e && i.isError(o) && a && w(o, n) || s) && y(o, n, "Got unwanted exception" + r), e && o && n && !w(o, n) || !e && o) throw o
    }
    f.AssertionError = function(e) {
      var t;
      this.name = "AssertionError", this.actual = e.actual, this.expected = e.expected, this.operator = e.operator, e.message ? (this.message = e.message, this.generatedMessage = !1) : (this.message = d(g((t = this).actual), 128) + " " + t.operator + " " + d(g(t.expected), 128), this.generatedMessage = !0);
    ...
    }, i.inherits(f.AssertionError, Error), f.fail = y, f.ok = v, f.equal = function(e, t, n) {
      e != t && y(e, t, n, "==", f.equal)
  ...
  (function(e) {
    ...
    }, n(63), t.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== e && e.setImmediate || this && this.setImmediate, t.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== e && e.clearImmediate || this && this.clearImmediate
  }).call(this, n(9))
}, function(e, t, n) {
  (function(e, t) {
    ! function(e, n) {
  ...
  (t = e.exports = n(36)).Stream = t, t.Readable = t, t.Writable = n(41), t.Duplex = n(10), t.Transform = n(42), t.PassThrough = n(67)
}, function(e, t, n) {
  "use strict";
  e.exports = i;
  var r = n(42),
  ...
  n(35).inherits(o, Error), e.exports = function(e) {
    return function(e) {
    ...
    function i(e, r) {
      ...
      switch (h) {
        ...
        case 207:
          for (f = 7; f >= 0; f--) p += e.readUInt8(r + f + 1) * Math.pow(2, 8 * (7 - f));
          return n(p, 9);
        case 208:
  ...
  function a(e, t) {
    var n;
    return (n = r.allocUnsafe(5))[0] = 202, n.writeFloatBE(e, 1), (t || Math.abs(e - n.readFloatBE(1)) > i) && ((n = r.allocUnsafe(9))[0] = 203, n.writeDoubleBE(e, 1)), n
  }
  e.exports = function(e, t, n, i) {
    function s(c, u) {
      ...
      if (null === c)(l = r.allocUnsafe(1))[0] = 192;
        ...
        if (!i && "function" == typeof c.getDate) return function(e) {
          var t, n = 1 * e,
            i = Math.floor(n / 1e3),
            a = 1e6 * (n - 1e3 * i);
          if (a || i > 4294967295) {
        ...
        if ("object" == typeof c) l = function(t) {
          ...
          if ((h = c) !== Math.floor(h)) return a(c, t);
          if (c >= 0)
            ...
            if (!(c <= 9007199254740991)) return a(c, !0);
  ...
  var r = n(72),
    ...
    a = function() {
      function e(e) {
        this.batchData = e;
        var t = new l(e);
        this.arrayRangeReader = new f(e), this.arrayBuilderSegmentReader = new h(e), this.diffReader = new s(e), this.editReader = new c(e, t), this.frameReader = new u(e, t)
      }
      return e.prototype.updatedComponents = function() {
        return p(this.batchData, this.batchData.length - 20)
      }, e.prototype.referenceFrames = function() {
        return p(this.batchData, this.batchData.length - 16)
      }, e.prototype.disposedComponentIds = function() {
        return p(this.batchData, this.batchData.length - 12)
      }, e.prototype.disposedEventHandlerIds = function() {
        return p(this.batchData, this.batchData.length - 8)
      }, e.prototype.updatedComponentsEntry = function(e, t) {
        var n = e + 4 * t;
        return p(this.batchData, n)
        ...
        var n = e + 8 * t;
        return g(this.batchData, n)
      }, e
    }();
  t.OutOfProcessRenderBatch = a;
  var s = function() {
      function e(e) {
        this.batchDataUint8 = e
      }
      return e.prototype.componentId = function(e) {
        return p(this.batchDataUint8, e)
    ...
    u = function() {
      ...
      return e.prototype.frameType = function(e) {
        ...
        return g(this.batchDataUint8, e + 12)
      }, e
    }(),
    l = function() {
      function e(e) {
        this.batchDataUint8 = e, this.stringTableStartIndex = p(e, e.length - 4)
      }
      return e.prototype.readString = function(e) {
        if (-1 === e) return null;
        var t, n = p(this.batchDataUint8, this.stringTableStartIndex + 4 * e),
          o = function(e, t) {
  ...
  function g(e, t) {
    var n = d(e, t + 4);
    if (n > i) throw new Error("Cannot read uint64 with high order part " + n + ", because the result would exceed Number.MAX_SAFE_INTEGER.");
    return n * o + d(e, t)
  }
}, function(e, t, n) {
  "use strict";
  ...
  t.ComponentDescriptor = c, t.discoverComponents = function(e) {
    for (var t = function e(t) {
        if (!t.hasChildNodes()) return [];
        for (var n = [], r = new h(t.childNodes); r.next() && r.currentElement;) {
          var o = l(r);
          if (o) n.push(o);
          else
      ...
      try {
        return function(e, t, n) {
          var r = JSON.parse(e),
            ...
            a = r.descriptor,
            s = r.prerenderId;
          if ("server" !== o) throw new Error("Invalid component type '" + o + "'.");
          if (!a) throw new Error("descriptor must be defined when using a descriptor.");
          if (void 0 === i) throw new Error("sequence must be defined when using a descriptor.");
          if (!Number.isInteger(i)) throw new Error("Error parsing the sequence '" + i + "' for component '" + e + "'");
          if (s) {
            var c = function(e, t) {
        ...
        throw new Error("Found malformed component comment at " + t.textContent)
      }
    }
  }
  ...
  t.resolveOptions = function(e) {
    var t = r({}, i, e);
    return e && e.reconnectionOptions && (t.reconnectionOptions = r({}, i.reconnectionOptions, e.reconnectionOptions)), t
  };
  var i = {
    ...
    c = function() {
      ...
      return e.prototype.onConnectionDown = function(e, t) {
        if (!this._reconnectionDisplay) {
          ...
          this._reconnectionDisplay = n ? new a.UserSpecifiedDisplay(n) : new i.DefaultReconnectDisplay(e.dialogId, document, this._logger)
        }
        ...
        return o(this, function(r) {
          switch (r.label) {
            case 0:
              t = 0, r.label = 1;
            case 1:
              return t < e.maxRetries ? [4, this.delay(e.retryIntervalMilliseconds)] : [3, 7];
            case 2:
              if (r.sent(), this.isDisposed) return [3, 7];
              r.label = 3;
            case 3:
              return r.trys.push([3, 5, , 6]), [4, this.reconnectCallback()];
            case 4:
              return r.sent() ? [2] : (this.reconnectDisplay.rejected(), [2]);
            case 5:
              return n = r.sent(), this.logger.log(s.LogLevel.Error, n), [3, 6];
            case 6:
              return t++, [3, 1];
            case 7:
  ...
  var i = n(16),
    a = function() {
      function e(e, t, n) {
        var a = this;
        this.document = t, this.logger = n, this.addedToDom = !1, this.modal = this.document.createElement("div"), this.modal.id = e;
        this.modal.style.cssText = ["position: fixed", "top: 0", "right: 0", "bottom: 0", "left: 0", "z-index: 1000", "display: none", "overflow: hidden", "background-color: #fff", "opacity: 0.8", "text-align: center", "font-weight: bold"].join(";"), this.modal.innerHTML = '<h5 style="margin-top: 20px"></h5><button style="margin:5px auto 5px">Retry</button><p>Alternatively, <a href>reload</a></p>', this.message = this.modal.querySelector("h5"), this.button = this.modal.querySelector("button"), this.reloadParagraph = this.modal.querySelector("p"), this.button.addEventListener("click", function() {
      ...
      return e.prototype.show = function() {
        this.addedToDom || (this.addedToDom = !0, this.document.body.appendChild(this.modal)), this.modal.style.display = "block", this.button.style.display = "none", this.reloadParagraph.style.display = "none", this.message.textContent = "Attempting to reconnect to the server..."
      }, e.prototype.hide = function() {
        this.modal.style.display = "none"
      }, e.prototype.failed = function() {
        this.button.style.display = "block", this.reloadParagraph.style.display = "none", this.message.innerHTML = "Reconnection failed. Try <a href>reloading</a> the page if you're unable to reconnect.", this.message.querySelector("a").addEventListener("click", function() {
          return location.reload()
        })
      }, e.prototype.rejected = function() {
        this.button.style.display = "none", this.reloadParagraph.style.display = "none", this.message.innerHTML = "Could not reconnect to the server. <a href>Reload</a> the page to restore functionality.", this.message.querySelector("a").addEventListener("click", function() {
          return location.reload()
        })
      }, e
    }();
  ...
  var r = function() {
    ...
    }, e.ShowClassName = "components-reconnect-show", e.HideClassName = "components-reconnect-hide", e.FailedClassName = "components-reconnect-failed", e.RejectedClassName = "components-reconnect-rejected", e
  }();
  ...
  var s = new Uint8Array([145, i.MessageType.Ping]),
    c = function() {
      function e() {
        this.name = "messagepack", this.version = 1, this.transferFormat = i.TransferFormat.Binary, this.errorResult = 1, this.voidResult = 2, this.nonVoidResult = 3
      }
      return e.prototype.parseMessages = function(e, t) {
        ...
        var t = o().encode([i.MessageType.Invocation, e.headers || {}, e.invocationId || null, e.target, e.arguments, e.streamIds]);
        return a.write(t.slice())
      }, e.prototype.writeStreamInvocation = function(e) {
        var t = o().encode([i.MessageType.StreamInvocation, e.headers || {}, e.invocationId, e.target, e.arguments, e.streamIds]);
        return a.write(t.slice())
      }, e.prototype.writeStreamItem = function(e) {
        var t = o().encode([i.MessageType.StreamItem, e.headers || {}, e.invocationId, e.item]);
        return a.write(t.slice())
        ...
        var t = o().encode([i.MessageType.CancelInvocation, e.headers || {}, e.invocationId]);
        return a.write(t.slice())
