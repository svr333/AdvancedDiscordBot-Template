! function(t) {
  ...
  Object.defineProperty(e, "__esModule", {
    value: !0
  }), e.matBlazorInstance = "$matBlazorInstance", e.getMatBlazorInstance = function(t) {
  ...
  var i, r = n(113),
    ...
    a = e.MatSelect = function t(e, n, i, a) {
      ...
      ! function(t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
      }(this, t), this.select = new r.MDCSelect(e), this.select.value = i, console.log("MatSelect.init", a), a.fullWidth || (0, o.hoistMenuToBody)(this.select.menu), this.select.listen("MDCSelect:change", (function() {
  ...
  Object.defineProperty(e, "__esModule", {
    ...
    console.log("matdialog-log-setIsOpen", !!e), e ? t.matBlazorRef.open() : t.matBlazorRef.close()
  }, e.setCanBeClosed = function(t, e) {
    console.log("matdialog-log-setCanBeClosed", !!e), e ? (t.matBlazorRef.escapeKeyAction = "close", t.matBlazorRef.scrimClickAction = "close") : (t.matBlazorRef.escapeKeyAction = "", t.matBlazorRef.scrimClickAction = "")
  };
  var i = n(156)
}, function(t, e, n) {
  "use strict";
  ...
  var i, r = (i = n(179)) && i.__esModule ? i : {
      default: i
    },
    o = n(9)
}, function(t, e, n) {
  ...
  o = function() {
    ...
    var p = function() {},
      ...
      C = function(t) {
        ...
        return function(t, e, n) {
          var i = n || a;
          return void 0 !== r.formatDate ? r.formatDate(t, e, i) : e.split("").map((function(e, n, o) {
            return g[e] && "\\" !== o[n - 1] ? g[e](t, i, r) : "\\" !== e ? e : ""
          })).join("")
        }
      },
      y = function(t) {
        ...
        return function(t, e, i, o) {
          if (0 === t || t) {
            ...
            if (t instanceof Date) s = new Date(t.getTime());
              ...
              var l = e || (r || n).dateFormat,
                d = String(t).trim();
              if ("today" === d) s = new Date, i = !0;
              else if (/Z$/.test(d) || /GMT$/.test(d)) s = new Date(t);
              else if (r && r.parseDate) s = r.parseDate(t, l);
              else {
                s = r && r.noCalendar ? new Date((new Date).setHours(0, 0, 0, 0)) : new Date((new Date).getFullYear(), 0, 1, 0, 0, 0, 0);
                for (var f = void 0, p = [], h = 0, g = 0, C = ""; h < l.length; h++) {
                  var y = l[h],
                    E = "\\" === y,
                    v = "\\" === l[h - 1] || E;
                  if (m[y] && !v) {
                    C += m[y];
                    var b = new RegExp(C).exec(t);
                    b && (f = !0) && p["Y" !== y ? "push" : "unshift"]({
                      fn: _[y],
                      val: b[++g]
                    })
                  } else E || (C += ".");
    ...
    function b(p, _) {
      ...
      function I(t) {
        0 === g.selectedDates.length && it(), void 0 !== t && "blur" !== t.type && function(t) {
          ...
          var i = parseFloat(n.getAttribute("min")),
            ...
            u = c + s * (t.delta || (e ? 38 === t.which ? 1 : -1 : 0));
          if (void 0 !== n.value && 2 === n.value.length) {
            var l = n === g.hourElement,
              d = n === g.minuteElement;
            u < i ? (u = a + u + o(!l) + (o(l) && o(!g.amPM)), d && F(void 0, -1, g.hourElement)) : a < u && (u = n === g.hourElement ? u - a - o(!g.amPM) : i, d && F(void 0, 1, g.hourElement)), g.amPM && l && (1 === s ? u + c === 23 : Math.abs(u - c) > s) && (g.amPM.textContent = g.l10n.amPM[o(g.amPM.textContent === g.l10n.amPM[0])]), n.value = r(u)
          }
        }(t);
        var e = g._input.value;
        O(), Ct(), g._input.value !== e && g._debouncedChange()
      }

      function O() {
        if (void 0 !== g.hourElement && void 0 !== g.minuteElement) {
          var t, e, n = (parseInt(g.hourElement.value.slice(-2), 10) || 0) % 24,
            i = (parseInt(g.minuteElement.value, 10) || 0) % 60,
            r = void 0 !== g.secondElement ? (parseInt(g.secondElement.value, 10) || 0) % 60 : 0;
          void 0 !== g.amPM && (t = n, e = g.amPM.textContent, n = t % 12 + 12 * o(e === g.l10n.amPM[1]));
          var a = void 0 !== g.config.minTime || g.config.minDate && g.minDateHasTime && g.latestSelectedDateObj && 0 === E(g.latestSelectedDateObj, g.config.minDate, !0);
          if (void 0 !== g.config.maxTime || g.config.maxDate && g.maxDateHasTime && g.latestSelectedDateObj && 0 === E(g.latestSelectedDateObj, g.config.maxDate, !0)) {
          ...
          if (a) {
            ...
            (n = Math.max(n, c.getHours())) === c.getHours() && (i = Math.max(i, c.getMinutes())), i === c.getMinutes() && (r = Math.max(r, c.getSeconds()))
          }
          M(n, i, r)
        }
      }
      ...
      function D() {
        ...
        if (void 0 !== g.config.minDate) {
          ...
          (t = Math.max(t, i)) === i && (e = Math.max(r, e)), t === i && e === r && (n = g.config.minDate.getSeconds())
        }
      ...
      function M(t, e, n) {
        void 0 !== g.latestSelectedDateObj && g.latestSelectedDateObj.setHours(t % 24, e, n || 0, 0), g.hourElement && g.minuteElement && !g.isMobile && (g.hourElement.value = r(g.config.time_24hr ? t : (12 + t) % 12 + 12 * o(t % 12 == 0)), g.minuteElement.value = r(e), void 0 !== g.amPM && (g.amPM.textContent = g.l10n.amPM[o(12 <= t)]), void 0 !== g.secondElement && (g.secondElement.value = r(n)))
      }

      function R(t) {
        var e = parseInt(t.target.value) + (t.delta || 0);
        (1 < e / 1e3 || "Enter" === t.key && !/[^\d]/.test(e.toString())) && J(e)
      }
      ...
      function L(t, e, n, i) {
        return e instanceof Array ? e.forEach((function(e) {
          ...
          return L(t, e, n, i)
        })) : (t.addEventListener(e, n, i), void g._handlers.push({
          element: t,
          event: e,
          handler: n,
          options: i
      ...
      function w(t, e) {
        ...
        e && g.currentYear !== i && (pt("onYearChange"), U()), !e || g.currentYear === i && g.currentMonth === r || pt("onMonthChange"), g.redraw()
      }

      function P(t) {
        ~t.target.className.indexOf("arrow") && F(t, t.target.classList.contains("arrowUp") ? 1 : -1)
      }
      ...
      function k(t, e, n, i) {
        ...
        return o.dateObj = e, o.$i = i, o.setAttribute("aria-label", g.formatDate(e, g.config.ariaDateFormat)), -1 === t.indexOf("hidden") && 0 === E(e, g.now) && ((g.todayDateElem = o).classList.add("today"), o.setAttribute("aria-current", "date")), r ? (o.tabIndex = -1, _t(e) && (o.classList.add("selected"), g.selectedDateElem = o, "range" === g.config.mode && (u(o, "startRange", g.selectedDates[0] && 0 === E(e, g.selectedDates[0], !0)), u(o, "endRange", g.selectedDates[1] && 0 === E(e, g.selectedDates[1], !0)), "nextMonthDay" === t && o.classList.add("inRange")))) : o.classList.add("flatpickr-disabled"), "range" === g.config.mode && (! function(t) {
          return !("range" !== g.config.mode || g.selectedDates.length < 2) && 0 <= E(t, g.selectedDates[0]) && E(t, g.selectedDates[1]) <= 0
        }(e) || _t(e) || o.classList.add("inRange")), g.weekNumbers && 1 === g.config.showMonths && "prevMonthDay" !== t && n % 7 == 1 && g.weekNumbers.insertAdjacentHTML("beforeend", "<span class='flatpickr-day'>" + g.config.getWeek(e) + "</span>"), pt("onDayCreate", o), o
      }

      function H(t) {
        t.focus(), "range" === g.config.mode && et(t)
      }

      function j(t) {
        for (var e = 0 < t ? 0 : g.config.showMonths - 1, n = 0 < t ? g.config.showMonths : -1, i = e; i != n; i += t)
          for (var r = g.daysContainer.children[i], o = 0 < t ? 0 : r.children.length - 1, a = 0 < t ? r.children.length : -1, s = o; s != a; s += t) {
            var c = r.children[s];
      ...
      function B(t, e) {
        var n = $(document.activeElement || document.body),
          i = void 0 !== t ? t : n ? document.activeElement : void 0 !== g.selectedDateElem && $(g.selectedDateElem) ? g.selectedDateElem : void 0 !== g.todayDateElem && $(g.todayDateElem) ? g.todayDateElem : j(0 < e ? 1 : -1);
        return void 0 === i ? g._input.focus() : n ? void
        function(t, e) {
          for (var n = -1 === t.className.indexOf("Month") ? t.dateObj.getMonth() : g.currentMonth, i = 0 < e ? g.config.showMonths : -1, r = 0 < e ? 1 : -1, o = n - g.currentMonth; o != i; o += r)
            for (var a = g.daysContainer.children[o], s = n - g.currentMonth === o ? t.$i + e : e < 0 ? a.children.length - 1 : 0, c = a.children.length, u = s; 0 <= u && u < c && u != (0 < e ? c : -1); u += r) {
              var l = a.children[u];
              if (-1 === l.className.indexOf("hidden") && Z(l.dateObj) && Math.abs(t.$i - u) >= Math.abs(e)) return H(l)
            }
          g.changeMonth(r), B(j(r), 0)
        }(i, e): H(i)
      }

      function V(t, e) {
        for (var n = (new Date(t, e, 1).getDay() - g.l10n.firstDayOfWeek + 7) % 7, i = g.utils.getDaysInMonth((e - 1 + 12) % 12), r = g.utils.getDaysInMonth(e), o = window.document.createDocumentFragment(), a = 1 < g.config.showMonths, s = a ? "prevMonthDay hidden" : "prevMonthDay", c = a ? "nextMonthDay hidden" : "nextMonthDay", u = i + 1 - n, d = 0; u <= i; u++, d++) o.appendChild(k(s, new Date(t, e - 1, u), u, d));
        for (u = 1; u <= r; u++, d++) o.appendChild(k("", new Date(t, e, u), u, d));
        for (var f = r + 1; f <= 42 - n && (1 === g.config.showMonths || d % 7 != 0); f++, d++) o.appendChild(k(c, new Date(t, e + 1, f % r), f, d));
      ...
      function K() {
        if (void 0 !== g.daysContainer) {
          ...
          for (var t = document.createDocumentFragment(), e = 0; e < g.config.showMonths; e++) {
            ...
            n.setMonth(g.currentMonth + e), t.appendChild(V(n.getFullYear(), n.getMonth()))
          }
          g.daysContainer.appendChild(t), g.days = g.daysContainer.firstChild, "range" === g.config.mode && 1 === g.selectedDates.length && et()
        }
      }
        ...
        if (!(1 < g.config.showMonths || "dropdown" !== g.config.monthSelectorType)) {
          ...
          for (var e = 0; e < 12; e++)
            if (t(e)) {
              ...
              n.value = new Date(g.currentYear, e).getMonth().toString(), n.textContent = h(e, g.config.shorthandCurrentMonth, g.l10n), n.tabIndex = -1, g.currentMonth === e && (n.selected = !0), g.monthsDropdownContainer.appendChild(n)
            }
        }
      }
      ...
      function W() {
        ...
        t = 1 < g.config.showMonths || "static" === g.config.monthSelectorType ? l("span", "cur-month") : (g.monthsDropdownContainer = l("select", "flatpickr-monthDropdown-months"), L(g.monthsDropdownContainer, "change", (function(t) {
          var e = t.target,
            n = parseInt(e.value, 10);
          g.changeMonth(n - g.currentMonth), pt("onMonthChange")
        })), U(), g.monthsDropdownContainer);
        var i = f("cur-year", {
            tabindex: "-1"
          }),
          r = i.getElementsByTagName("input")[0];
        r.setAttribute("aria-label", g.l10n.yearAriaLabel), g.config.minDate && r.setAttribute("min", g.config.minDate.getFullYear().toString()), g.config.maxDate && (r.setAttribute("max", g.config.maxDate.getFullYear().toString()), r.disabled = !!g.config.minDate && g.config.minDate.getFullYear() === g.config.maxDate.getFullYear());
        var o = l("div", "flatpickr-current-month");
        return o.appendChild(t), o.appendChild(i), n.appendChild(o), e.appendChild(n), {
          container: e,
          yearElement: r,
          monthElement: t
        }
      ...
      function q(t, e) {
        ...
        n < 0 && !0 === g._hidePrevMonthArrow || 0 < n && !0 === g._hideNextMonthArrow || (g.currentMonth += n, (g.currentMonth < 0 || 11 < g.currentMonth) && (g.currentYear += 11 < g.currentMonth ? 1 : -1, g.currentMonth = (g.currentMonth + 12) % 12, pt("onYearChange"), U()), K(), pt("onMonthChange"), mt())
      }
      ...
      function Q(t) {
        if (g.isOpen && !g.config.inline) {
          var e = "function" != typeof(a = t).composedPath ? a.target : a.composedPath()[0],
            n = X(e),
            i = e === g.input || e === g.altInput || g.element.contains(e) || t.path && t.path.indexOf && (~t.path.indexOf(g.input) || ~t.path.indexOf(g.altInput)),
            r = "blur" === t.type ? i && t.relatedTarget && !X(t.relatedTarget) : !i && !n && !X(t.relatedTarget),
            o = !g.config.ignoredFocusElements.some((function(t) {
              return t.contains(e)
            }));
          r && o && (void 0 !== g.timeContainer && void 0 !== g.minuteElement && void 0 !== g.hourElement && I(), g.close(), "range" === g.config.mode && 1 === g.selectedDates.length && (g.clear(!1), g.redraw()))
        }
        var a
      }
      ...
      function Z(t, e) {
        ...
        if (g.config.minDate && n && E(n, g.config.minDate, void 0 !== e ? e : !g.minDateHasTime) < 0 || g.config.maxDate && n && 0 < E(n, g.config.maxDate, void 0 !== e ? e : !g.maxDateHasTime)) return !1;
        if (0 === g.config.enable.length && 0 === g.config.disable.length) return !0;
        if (void 0 === n) return !1;
        for (var i = 0 < g.config.enable.length, r = i ? g.config.enable : g.config.disable, o = 0, s = void 0; o < r.length; o++) {
          if ("function" == typeof(s = r[o]) && s(n)) return i;
          if (s instanceof Date && void 0 !== n && s.getTime() === n.getTime()) return i;
          if ("string" == typeof s && void 0 !== n) {
            var c = g.parseDate(s, void 0, !0);
            return c && c.getTime() === n.getTime() ? i : !i
          }
          if ("object" === (void 0 === s ? "undefined" : a(s)) && void 0 !== n && s.from && s.to && n.getTime() >= s.from.getTime() && n.getTime() <= s.to.getTime()) return i
        }
        return !i
      }
      ...
      function tt(t) {
        ...
        if (13 === t.keyCode && e) {
          ...
          switch (t.keyCode) {
            ...
            case 39:
              ...
              else if (t.preventDefault(), void 0 !== g.daysContainer && (!1 === n || document.activeElement && $(document.activeElement))) {
                var a = 39 === t.keyCode ? 1 : -1;
                t.ctrlKey ? (t.stopPropagation(), q(a), B(j(1), 0)) : B(void 0, a)
              }
              break;
            case 38:
            case 40:
              ...
              g.daysContainer && void 0 !== t.target.$i || t.target === g.input || t.target === g.altInput ? t.ctrlKey ? (t.stopPropagation(), J(g.currentYear - s), B(j(1), 0)) : o || B(void 0, 7 * s) : t.target === g.currentYearElement ? J(g.currentYear - s) : g.config.enableTime && (!o && g.hourElement && g.hourElement.focus(), I(t), g._debouncedChange());
              break;
            case 9:
              if (o) {
                ...
                if (-1 !== u) {
                  ...
                  t.preventDefault(), (l || g._input).focus()
                }
        ...
        if (void 0 !== g.amPM && t.target === g.amPM) switch (t.key) {
          ...
          case g.l10n.amPM[0].charAt(0).toLowerCase():
            g.amPM.textContent = g.l10n.amPM[0], O(), Ct();
            break;
          case g.l10n.amPM[1].charAt(0):
          case g.l10n.amPM[1].charAt(0).toLowerCase():
            g.amPM.textContent = g.l10n.amPM[1], O(), Ct()
        }(e || X(t.target)) && pt("onKeyDown", t)
      }

      function et(t) {
        if (1 === g.selectedDates.length && (!t || t.classList.contains("flatpickr-day") && !t.classList.contains("flatpickr-disabled"))) {
          for (var e = t ? t.dateObj.getTime() : g.days.firstElementChild.dateObj.getTime(), n = g.parseDate(g.selectedDates[0], void 0, !0).getTime(), i = Math.min(e, g.selectedDates[0].getTime()), r = Math.max(e, g.selectedDates[0].getTime()), o = !1, a = 0, s = 0, c = i; c < r; c += v) Z(new Date(c), !0) || (o = o || i < c && c < r, c < n && (!a || a < c) ? a = c : n < c && (!s || c < s) && (s = c));
          for (var u = 0; u < g.config.showMonths; u++)
            for (var l = g.daysContainer.children[u], d = function(i) {
                var r, c, u, d = l.children[i],
                  f = d.dateObj.getTime(),
                  p = 0 < a && f < a || 0 < s && s < f;
                return p ? (d.classList.add("notAllowed"), ["inRange", "startRange", "endRange"].forEach((function(t) {
                  d.classList.remove(t)
                })), "continue") : o && !p ? "continue" : (["startRange", "inRange", "endRange", "notAllowed"].forEach((function(t) {
                  d.classList.remove(t)
                })), void(void 0 !== t && (t.classList.add(e <= g.selectedDates[0].getTime() ? "startRange" : "endRange"), n < e && f === n ? d.classList.add("startRange") : e < n && f === n && d.classList.add("endRange"), a <= f && (0 === s || f <= s) && (r = f, c = n, u = e, r > Math.min(c, u) && r < Math.max(c, u)) && d.classList.add("inRange"))))
              }, f = 0, p = l.children.length; f < p; f++) d(f)
        }
      }

      function nt() {
        !g.isOpen || g.config.static || g.config.inline || at()
      }

      function it() {
        g.setDate(void 0 !== g.config.minDate ? new Date(g.config.minDate.getTime()) : new Date, !0), D(), Ct()
      }
      ...
      function rt(t) {
        return function(e) {
          ...
          void 0 !== n && (g["min" === t ? "minDateHasTime" : "maxDateHasTime"] = 0 < n.getHours() || 0 < n.getMinutes() || 0 < n.getSeconds()), g.selectedDates && (g.selectedDates = g.selectedDates.filter((function(t) {
            return Z(t)
          })), g.selectedDates.length || "min" !== t || S(n), Ct()), g.daysContainer && (st(), void 0 !== n ? g.currentYearElement[t] = n.getFullYear().toString() : g.currentYearElement.removeAttribute(t), g.currentYearElement.disabled = !!i && void 0 !== n && i.getFullYear() === n.getFullYear())
        }
      }

      function ot() {
        "object" !== a(g.config.locale) && void 0 === T.l10ns[g.config.locale] && g.config.errorHandler(new Error("flatpickr: invalid locale " + g.config.locale)), g.l10n = t({}, T.l10ns.default, "object" === a(g.config.locale) ? g.config.locale : "default" !== g.config.locale ? T.l10ns[g.config.locale] : void 0), m.K = "(" + g.l10n.amPM[0] + "|" + g.l10n.amPM[1] + "|" + g.l10n.amPM[0].toLowerCase() + "|" + g.l10n.amPM[1].toLowerCase() + ")", void 0 === t({}, _, JSON.parse(JSON.stringify(p.dataset || {}))).time_24hr && void 0 === T.defaultConfig.time_24hr && (g.config.time_24hr = g.l10n.time_24hr), g.formatDate = C(g), g.parseDate = y({
          config: g.config,
          l10n: g.l10n
        })
      }
      ...
      function at(t) {
        if (void 0 !== g.calendarContainer) {
          ...
          var e = t || g._positionElement,
            ...
            o = r[0],
            a = 1 < r.length ? r[1] : null,
            s = e.getBoundingClientRect(),
            c = window.innerHeight - s.bottom,
            l = "above" === o || "below" !== o && c < n && s.top > n,
            d = window.pageYOffset + s.top + (l ? -n - 2 : e.offsetHeight + 2);
          if (u(g.calendarContainer, "arrowTop", !l), u(g.calendarContainer, "arrowBottom", l), !g.config.inline) {
            var f = window.pageXOffset + s.left - (null != a && "center" === a ? (i - s.width) / 2 : 0),
              ...
              _ = p + i > window.document.body.offsetWidth;
            if (u(g.calendarContainer, "rightMost", h), !g.config.static)
              if (g.calendarContainer.style.top = d + "px", h)
                if (_) {
                  var m = document.styleSheets[0];
                  if (void 0 === m) return;
                  var C = window.document.body.offsetWidth,
                    y = Math.max(0, C / 2 - i / 2),
                    E = m.cssRules.length,
                    v = "{left:" + s.left + "px;right:auto;}";
                  u(g.calendarContainer, "rightMost", !1), u(g.calendarContainer, "centerMost", !0), m.insertRule(".flatpickr-calendar.centerMost:before,.flatpickr-calendar.centerMost:after" + v, E), g.calendarContainer.style.left = y + "px", g.calendarContainer.style.right = "auto"
                } else g.calendarContainer.style.left = "auto", g.calendarContainer.style.right = p + "px";
      ...
      function st() {
        g.config.noCalendar || g.isMobile || (mt(), K())
      }
      ...
      function ut(t) {
        ...
        if (void 0 !== e) {
          var n = e,
            ...
            r = (i.getMonth() < g.currentMonth || i.getMonth() > g.currentMonth + g.config.showMonths - 1) && "range" !== g.config.mode;
          if (g.selectedDateElem = n, "single" === g.config.mode) g.selectedDates = [i];
          else if ("multiple" === g.config.mode) {
            var o = _t(i);
            o ? g.selectedDates.splice(parseInt(o), 1) : g.selectedDates.push(i)
          } else "range" === g.config.mode && (2 === g.selectedDates.length && g.clear(!1, !1), g.latestSelectedDateObj = i, g.selectedDates.push(i), 0 !== E(i, g.selectedDates[0], !0) && g.selectedDates.sort((function(t, e) {
            return t.getTime() - e.getTime()
          })));
          if (O(), r) {
            var a = g.currentYear !== i.getFullYear();
            g.currentYear = i.getFullYear(), g.currentMonth = i.getMonth(), a && (pt("onYearChange"), U()), pt("onMonthChange")
          }
          if (mt(), K(), Ct(), g.config.enableTime && setTimeout((function() {
              return g.showTimeInput = !0
            }), 50), r || "range" === g.config.mode || 1 !== g.config.showMonths ? void 0 !== g.selectedDateElem && void 0 === g.hourElement && g.selectedDateElem && g.selectedDateElem.focus() : H(n), void 0 !== g.hourElement && void 0 !== g.hourElement && g.hourElement.focus(), g.config.closeOnSelect) {
      ...
      g.parseDate = y({
        config: g.config,
        l10n: g.l10n
      }), g._handlers = [], g.pluginElements = [], g.loadedPlugins = [], g._bind = L, g._setHoursFromDate = S, g._positionCalendar = at, g.changeMonth = q, g.changeYear = J, g.clear = function(t, e) {
      ...
      }, g.isEnabled = Z, g.jumpToDate = w, g.open = function(t, e) {
        ...
        if (!g._input.disabled && !g.config.inline) {
          var n = g.isOpen;
          g.isOpen = !0, n || (g.calendarContainer.classList.add("open"), g._input.classList.add("active"), pt("onOpen"), at(e)), !0 === g.config.enableTime && !0 === g.config.noCalendar && (0 === g.selectedDates.length && it(), !1 !== g.config.allowInput || void 0 !== t && g.timeContainer.contains(t.relatedTarget) || setTimeout((function() {
            return g.hourElement.select()
          }), 50))
        }
      }, g.redraw = st, g.set = function(t, n) {
        if (null !== t && "object" === (void 0 === t ? "undefined" : a(t)))
          for (var i in Object.assign(g.config, t), t) void 0 !== lt[i] && lt[i].forEach((function(t) {
            return t()
          }));
        else g.config[t] = n, void 0 !== lt[t] ? lt[t].forEach((function(t) {
          return t()
        })) : -1 < e.indexOf(t) && (g.config[t] = c(n));
        g.redraw(), Ct(!1)
      }, g.setDate = function(t, e, n) {
        if (void 0 === e && (e = !1), void 0 === n && (n = g.config.dateFormat), 0 !== t && !t || t instanceof Array && 0 === t.length) return g.clear(e);
        dt(t, n), g.showTimeInput = 0 < g.selectedDates.length, g.latestSelectedDateObj = g.selectedDates[g.selectedDates.length - 1], g.redraw(), w(), S(), 0 === g.selectedDates.length && g.clear(!1), Ct(e), e && pt("onChange")
      }, g.toggle = function(t) {
      ...
      function ft(t) {
        return t.slice().map((function(t) {
          return "string" == typeof t || "number" == typeof t || t instanceof Date ? g.parseDate(t, void 0, !0) : t && "object" === (void 0 === t ? "undefined" : a(t)) && t.from && t.to ? {
      ...
      function pt(t, e) {
        if (void 0 !== g.config) {
          ...
          if (void 0 !== n && 0 < n.length)
            for (var i = 0; n[i] && i < n.length; i++) n[i](g.selectedDates, g.input.value, g, e);
      ...
      function _t(t) {
        for (var e = 0; e < g.selectedDates.length; e++)
          if (0 === E(g.selectedDates[e], t)) return "" + e;
        return !1
      }
      ...
      function mt() {
        g.config.noCalendar || g.isMobile || !g.monthNav || (g.yearElements.forEach((function(t, e) {
          var n = new Date(g.currentYear, g.currentMonth, 1);
          n.setMonth(g.currentMonth + e), 1 < g.config.showMonths || "static" === g.config.monthSelectorType ? g.monthElements[e].textContent = h(n.getMonth(), g.config.shorthandCurrentMonth, g.l10n) + " " : g.monthsDropdownContainer.value = n.getMonth().toString(), t.value = n.getFullYear().toString()
      ...
      function Ct(t) {
        void 0 === t && (t = !0), void 0 !== g.mobileInput && g.mobileFormatStr && (g.mobileInput.value = void 0 !== g.latestSelectedDateObj ? g.formatDate(g.latestSelectedDateObj, g.mobileFormatStr) : ""), g.input.value = gt(g.config.dateFormat), void 0 !== g.altInput && (g.altInput.value = gt(g.config.altFormat)), !1 !== t && pt("onValueUpdate")
      }

      function yt(t) {
        var e = g.prevMonthNav.contains(t.target),
          n = g.nextMonthNav.contains(t.target);
        e || n ? q(e ? -1 : 1) : 0 <= g.yearElements.indexOf(t.target) ? t.target.select() : t.target.classList.contains("arrowUp") ? g.changeYear(g.currentYear + 1) : t.target.classList.contains("arrowDown") && g.changeYear(g.currentYear - 1)
      }
      return function() {
        g.element = g.input = p, g.isOpen = !1,
          function() {
            var i = ["wrap", "weekNumbers", "allowInput", "clickOpens", "time_24hr", "enableTime", "noCalendar", "altInput", "shorthandCurrentMonth", "inline", "static", "enableSeconds", "disableMobile"],
              r = t({}, _, JSON.parse(JSON.stringify(p.dataset || {}))),
              o = {};
            ...
            Object.defineProperty(g.config, "minTime", {
              ...
              set: l("max")
            }), "time" === r.mode && (g.config.noCalendar = !0, g.config.enableTime = !0), Object.assign(g.config, o, r);
            for (var d = 0; d < i.length; d++) g.config[i[d]] = !0 === g.config[i[d]] || "true" === g.config[i[d]];
            for (e.filter((function(t) {
                return void 0 !== g.config[t]
              })).forEach((function(t) {
                g.config[t] = c(g.config[t] || []).map(b)
              ...
              var f = g.config.plugins[d](g) || {};
              for (var h in f) - 1 < e.indexOf(h) ? g.config[h] = c(f[h]).map(b).concat(g.config[h]) : void 0 === r[h] && (g.config[h] = f[h])
            }
            pt("onParseConfig")
          }(), ot(),
          function() {
            if (g.input = g.config.wrap ? p.querySelector("[data-input]") : p, !g.input) return g.config.errorHandler(new Error("Invalid input element specified"));
            g.input._type = g.input.type, g.input.type = "text", g.input.classList.add("flatpickr-input"), g._input = g.input, g.config.altInput && (g.altInput = l(g.input.nodeName, g.config.altInputClass), g._input = g.altInput, g.altInput.placeholder = g.input.placeholder, g.altInput.disabled = g.input.disabled, g.altInput.required = g.input.required, g.altInput.tabIndex = g.input.tabIndex, g.altInput.type = "text", g.input.setAttribute("type", "hidden"), !g.config.static && g.input.parentNode && g.input.parentNode.insertBefore(g.altInput, g.input.nextSibling)), g.config.allowInput || g._input.setAttribute("readonly", "readonly"), g._positionElement = g.config.positionElement || g._input
          }(),
          function() {
            ...
            t && dt(t, g.config.dateFormat), g._initialDate = 0 < g.selectedDates.length ? g.selectedDates[0] : g.config.minDate && g.config.minDate.getTime() > g.now.getTime() ? g.config.minDate : g.config.maxDate && g.config.maxDate.getTime() < g.now.getTime() ? g.config.maxDate : g.now, g.currentYear = g._initialDate.getFullYear(), g.currentMonth = g._initialDate.getMonth(), 0 < g.selectedDates.length && (g.latestSelectedDateObj = g.selectedDates[0]), void 0 !== g.config.minTime && (g.config.minTime = g.parseDate(g.config.minTime, "H:i")), void 0 !== g.config.maxTime && (g.config.maxTime = g.parseDate(g.config.maxTime, "H:i")), g.minDateHasTime = !!g.config.minDate && (0 < g.config.minDate.getHours() || 0 < g.config.minDate.getMinutes() || 0 < g.config.minDate.getSeconds()), g.maxDateHasTime = !!g.config.maxDate && (0 < g.config.maxDate.getHours() || 0 < g.config.maxDate.getMinutes() || 0 < g.config.maxDate.getSeconds()), Object.defineProperty(g, "showTimeInput", {
              ...
              set: function(t) {
                g._showTimeInput = t, g.calendarContainer && u(g.calendarContainer, "showTimeInput", t), g.isOpen && at()
              }
            })
          }(), g.utils = {
            ...
            if (g.calendarContainer = l("div", "flatpickr-calendar"), g.calendarContainer.tabIndex = -1, !g.config.noCalendar) {
              if (t.appendChild((g.monthNav = l("div", "flatpickr-months"), g.yearElements = [], g.monthElements = [], g.prevMonthNav = l("span", "flatpickr-prev-month"), g.prevMonthNav.innerHTML = g.config.prevArrow, g.nextMonthNav = l("span", "flatpickr-next-month"), g.nextMonthNav.innerHTML = g.config.nextArrow, G(), Object.defineProperty(g, "_hidePrevMonthArrow", {
                  ...
                  set: function(t) {
                    g.__hideNextMonthArrow !== t && (u(g.nextMonthNav, "flatpickr-disabled", t), g.__hideNextMonthArrow = t)
                  }
                }), g.currentYearElement = g.yearElements[0], mt(), g.monthNav)), g.innerContainer = l("div", "flatpickr-innerContainer"), g.config.weekNumbers) {
                var e = function() {
                  ...
                  n = e.weekWrapper,
                  i = e.weekNumbers;
                g.innerContainer.appendChild(n), g.weekNumbers = i, g.weekWrapper = n
              }
              g.rContainer = l("div", "flatpickr-rContainer"), g.rContainer.appendChild(Y()), g.daysContainer || (g.daysContainer = l("div", "flatpickr-days"), g.daysContainer.tabIndex = -1), K(), g.rContainer.appendChild(g.daysContainer), g.innerContainer.appendChild(g.rContainer), t.appendChild(g.innerContainer)
            }
            g.config.enableTime && t.appendChild(function() {
              ...
              if (g.minuteElement = n.getElementsByTagName("input")[0], g.hourElement.tabIndex = g.minuteElement.tabIndex = -1, g.hourElement.value = r(g.latestSelectedDateObj ? g.latestSelectedDateObj.getHours() : g.config.time_24hr ? g.config.defaultHour : function(t) {
                  switch (t % 24) {
                    case 0:
                    case 12:
                      return 12;
                ...
                g.secondElement = i.getElementsByTagName("input")[0], g.secondElement.value = r(g.latestSelectedDateObj ? g.latestSelectedDateObj.getSeconds() : g.config.defaultSeconds), g.secondElement.setAttribute("step", g.minuteElement.getAttribute("step")), g.secondElement.setAttribute("min", "0"), g.secondElement.setAttribute("max", "59"), g.timeContainer.appendChild(l("span", "flatpickr-time-separator", ":")), g.timeContainer.appendChild(i)
              }
              return g.config.time_24hr || (g.amPM = l("span", "flatpickr-am-pm", g.l10n.amPM[o(11 < (g.latestSelectedDateObj ? g.hourElement.value : g.config.defaultHour))]), g.amPM.title = g.l10n.toggleTitle, g.amPM.tabIndex = -1, g.timeContainer.appendChild(g.amPM)), g.timeContainer
            }()), u(g.calendarContainer, "rangeMode", "range" === g.config.mode), u(g.calendarContainer, "animate", !0 === g.config.animate), u(g.calendarContainer, "multiMonth", 1 < g.config.showMonths), g.calendarContainer.appendChild(t);
          ...
          function() {
            if (g.config.wrap && ["open", "close", "toggle", "clear"].forEach((function(t) {
              ...
              L(g.mobileInput, "change", (function(t) {
                g.setDate(t.target.value, !1, g.mobileFormatStr), pt("onChange"), pt("onClose")
              }))
            }();
            var t = s(nt, 50);
            g._debouncedChange = s(N, 300), g.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && L(g.daysContainer, "mouseover", (function(t) {
              "range" === g.config.mode && et(t.target)
            })), L(window.document.body, "keydown", tt), g.config.inline || g.config.static || L(window, "resize", t), void 0 !== window.ontouchstart ? L(window.document, "touchstart", Q) : L(window.document, "mousedown", x(Q)), L(window.document, "focus", Q, {
              capture: !0
            }), !0 === g.config.clickOpens && (L(g._input, "focus", g.open), L(g._input, "mousedown", x(g.open))), void 0 !== g.daysContainer && (L(g.monthNav, "mousedown", x(yt)), L(g.monthNav, ["keyup", "increment"], R), L(g.daysContainer, "mousedown", x(ut))), void 0 !== g.timeContainer && void 0 !== g.minuteElement && void 0 !== g.hourElement && (L(g.timeContainer, ["increment"], I), L(g.timeContainer, "blur", I, {
              capture: !0
            }), L(g.timeContainer, "mousedown", x(P)), L([g.hourElement, g.minuteElement], ["focus", "click"], (function(t) {
            ...
            })), void 0 !== g.amPM && L(g.amPM, "mousedown", x((function(t) {
              I(t), N()
            }))))
          }(), (g.selectedDates.length || g.config.noCalendar) && (g.config.enableTime && S(g.config.noCalendar ? g.latestSelectedDateObj || g.config.minDate : void 0), Ct(!1)), A(), g.showTimeInput = 0 < g.selectedDates.length || g.config.noCalendar;
        var i = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
        !g.isMobile && i && at(), pt("onReady")
      }(), g
    }
    ...
    function A(t, e) {
      for (var n = Array.prototype.slice.call(t).filter((function(t) {
        ...
        try {
          ...
          void 0 !== o._flatpickr && (o._flatpickr.destroy(), o._flatpickr = void 0), o._flatpickr = b(o, e || {}), i.push(o._flatpickr)
        } catch (t) {
          console.error(t)
        }
      }
    ...
    var T = function(t, e) {
      return "string" == typeof t ? A(window.document.querySelectorAll(t), e) : t instanceof Node ? A([t], e) : A(t, e)
    };
    return T.defaultConfig = {}, T.l10ns = {
      en: t({}, i),
      default: t({}, i)
    }, T.localize = function(e) {
      T.l10ns.default = t({}, T.l10ns.default, e)
    }, T.setDefaults = function(e) {
      T.defaultConfig = t({}, T.defaultConfig, e)
    }, T.parseDate = y({}), T.formatDate = C({}), T.compareDates = E, "undefined" != typeof jQuery && void 0 !== jQuery.fn && (jQuery.fn.flatpickr = function(t) {
      return A(this, t)
        ...
        value: function(t) {
          ...
          switch (t) {
            case a.top:
              ...
              break;
            case a.bottom:
              e.x = n.left + this.targetRef.offsetWidth / 2 - this.ref.offsetWidth / 2, e.y = n.top + this.targetRef.offsetHeight + 10;
              break;
            case a.right:
  ...
  Object.defineProperty(e, "__esModule", {
    value: !0
  }), e.getScrollView = i, e.init = function(t, e) {
